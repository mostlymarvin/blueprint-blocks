...
class mbtSelectBook extends Component {
  ...
  constructor() {
    ...
    this.onChangeReadMoreLinkBGColor = this.onChangeReadMoreLinkBGColor.bind(
      this
    );
  ...
  getBlockSettings(options, message) {
    return this.props.attributes.title ? null : (
  ...
  onChangeSelectBook(value) {
    ...
    const bookSampleLink =
      "https://read.amazon.com/kp/embed?asin=" + bookSample + "&preview=newtab";
  ...
  readMoreButton() {
    ...
    return (
      <a href="#" className={buttonClass} style={buttonStyle}>
            ...
            <div className={"inner-preview is-flex " + flexClass}>
              ...
              <div className="preview-right">
                <div className="preview-right-top">
                  <h2 className="preview-title" style={titleStyle}>
                    {this.props.attributes.titlePrefix && (
                      <span className="title-prefix" style={prefixStyle}>
                        {this.props.attributes.titlePrefix}
                      </span>
                    )}
                    <span className="title">{this.props.attributes.title}</span>
                  </h2>
                    ...
                    <div className="buylinks">
                      ...
                      <div className="mbt-book-buybuttons blueprint">
                        {this.props.attributes.buylinks.map((item, key) => {
                          return (
                            <div
                              className="mbt-book-buybutton"
                              key={item.store}
                            >
                              <a className="image-link" href={item.url}>
                                <img
                                  className="image-link"
                                  src={
                                    this.props.attributes.styleURL +
                                    item.store +
                                    "_button.png"
                                  }
...
registerBlockType("blueprint-blocks/mbt-book", {
  ...
  keywords: [__("blueprint-blocks — mbt-book"), __("Book")],
  supports: {
  ...
  save: function(props) {
    ...
    if (
      props.attributes.colorBG === "#fff" ||
      props.attributes.colorBG === "#ffffff"
    ) {
    ...
    if (
      props.attributes.colorReadMoreLinkBG &&
        ...
        <div className={flexClass}>
          <div className="preview-left">
            {props.attributes.cover && (
              <a href={props.attributes.readMoreLink} className="image-link">
                <img
              ...
              <div className="cover-links">
                {props.attributes.bookSample && (
                  <span className="booksample">
                    <a href={props.attributes.bookSample}>View Book Sample</a>
                  </span>
                )}
                {props.attributes.bookSample &&
          ...
          <div className="preview-right">
            ...
            {props.attributes.showBuyLinks && props.attributes.buylinks && (
              <div className="buylinks">
                <h5 className="buttons-label" style={blockStyle}>
